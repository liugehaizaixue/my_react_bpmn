...
ContextPadProvider.prototype.getContextPadEntries = function (element) {
  ...
  if (is(businessObject, "bpmn:FlowNode")) {
    if (
      ...
      !is(businessObject, "bpmn:ServiceTask") &&
      ...
      assign(actions, {
        ...
        "append.append-task": appendAction(
          "bpmn:ServiceTask",
          "icon-custom service-task",
          translate("Append Service Task")
        ),
        "append.append-operation": appendAction(
          "bpmn:SendTask",
          "icon-custom operation",
          translate("Append operation")
        ),
        "append.append-function": appendAction(
          "bpmn:Task",
          "icon-custom func",
  ...
  if (isAny(businessObject, ["bpmn:DataObjectReference"])) {
    assign(actions, {
      connect: {
        group: "connect",
        className: "bpmn-icon-connection-multi",
